...
class Config:
    ...
    def _load_config(self):
        ...
        if self.config_file.exists():
            try:
                ...
                print(f"[Catsee] Failed to load config: {e}")
    ...
    def save_config(self, config=None):
        ...
        try:
            ...
            print(f"[Catsee] Config saved to {self.config_file}")
        except Exception as e:
            print(f"[Catsee] Failed to save config: {e}")
    ...
    def get_path(self, key):
        ...
        try:
            ...
            print(f"[Catsee] Warning: Cannot create directory {path}: {e}")
        return path
